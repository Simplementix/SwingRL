...
- [x] [agent-architecture.md](agent-architecture.md) — PPO/A2C/SAC configs, ensemble weights, epoch cadence
...
- [x] [validation-promotion.md](validation-promotion.md) — Sharpe/MDD gates, shadow → active → archive flow
