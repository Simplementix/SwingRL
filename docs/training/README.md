...
- [x] [reward-shaping.md](reward-shaping.md) `1395b31` — Reward formula, penalties, memory-driven adjustments, yaml weights
...
- [x] [training-data-capture.md](training-data-capture.md) `1395b31` — Per pg16 table: who writes, when, cardinality, readers
- [x] [memory-system.md](memory-system.md) `df88d18` — Memory types, consolidation phases, LLM chain, retrieval, known issues
- [x] [training-pipeline.md](training-pipeline.md) `347d983` — Iteration lifecycle, walk-forward structure, entry points
