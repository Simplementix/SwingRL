...
Computes technical indicators, normalizes, and stores features to PostgreSQL
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Compute and store SwingRL features to PostgreSQL.",
...
def main(argv: list[str] | None = None) -> int:
    ...
    # Connect to PostgreSQL via DatabaseManager
