...
# Renamed to *_legacy (user ruling 2026-07-17): the §4.5 pattern_presentations table
# (migration V006) ceded-to owns the bare name. Legacy memory writers keep this table
# until the Task 28 cutover. See migrations/V006__patterns.sql for the collision note.
_PATTERN_PRESENTATIONS_LEGACY_DDL = """\
